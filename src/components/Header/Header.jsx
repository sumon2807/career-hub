...
const Header = () => {
    ...
    return (
        <div className='flex justify-between items-center py-4 container mx-auto'>
            <div>
                <Link to='/' className='text-slate-800 text-3xl font-extrabold pl-4 lg:p-0 md:p-0'>Job<span className='text-cyan-600'>Finder</span></Link>
            </div>
            <div>
            <div className='md:hidden lg:hidden absolute right-0 pr-4' onClick={()=>setOpen(!open)}>
                ...
                <ul className={`text-slate-800 md:flex lg:flex font-bold mt-2 absolute md:static lg:static duration-500 ${open ? 'top-6' : '-top-48'}`}>
                    <li className='mx-4'>
