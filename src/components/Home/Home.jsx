        ...
        <div>
            <div className='flex lg:flex-row  container mx-auto my-10 items-center flex-col-reverse'>
                <div className="banner-details w-full lg:w-2/5">
                    <h1 className='text-3xl text-center md:text-left lg:text-left md:text-5xl lg:text-6xl font-extrabold text-slate-800 pl-4 md:pl-0 lg:pl-0  md:pt-6 lg:pt-20 md:pb-6'>One Step <br /> Closer To Your <br /><span className='text-cyan-600'>Dream Job</span></h1>
